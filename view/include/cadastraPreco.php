<div class="modal fade" id="modal-preco" tabindex="-1" role="dialog" aria-labelledby="modal-preco" aria-hidden="true">
						...
						<div class="modal-content">                  
                            ...
                            <form>
								<div class="modal-body" style="padding: 60px 1.5rem 1.5rem 1.5rem;">
									...
									<textarea class="form-control form-control-alternative" name="precoDescricao" id="precoDescricao" placeholder="Escreva aqui..."></textarea>
								</div>
