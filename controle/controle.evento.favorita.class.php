...
class ControleEventoFavorita extends ControleBase {
    private $visao;
    private $favorita;
    ...
    public function __construct() {
        ...
        $this->favorita = new EventoFavorita();
    }
    ...
    private function preencheModelo(){
        ...
        $this->favorita->setIdEvento((isset($this->visao["idEvento"]) && $this->visao["idEvento"] != null) ? $this->visao["idEvento"] : "");
